...
class AdminUsersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create admin_user" do
    assert_difference('AdminUser.count') do
      post admin_users_url, params: { admin_user: { mail: @admin_user.mail, name: @admin_user.name } }
    end
  ...
  test "should update admin_user" do
    patch admin_user_url(@admin_user), params: { admin_user: { mail: @admin_user.mail, name: @admin_user.name } }
